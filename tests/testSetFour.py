...
class TestSetFour(unittest.TestCase):
    ...
    def testReynardConstructorNoArguments(self):
        ...
        self.assertTrue(not hasattr(self.reynard,'pz_word_lengths_freqeuncy' )) 
    ...
    def testReynardConstructorWithArguments(self):
        ...
        self.assertTrue(hasattr(self.reynard,'pz_word_lengths_freqeuncy' )) 
    ...
    def testReasoner1(self):
        ...
        self.reasoner.createWordSearcher(self.puzzle.pz_word_lengths_freqeuncy.keys())
