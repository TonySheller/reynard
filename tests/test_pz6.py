...
class TestPz6(unittest.TestCase):
    '''
    ...
    def setUp(self):
        ...
        '''
        self.puzzle = Puzzle('/mnt/e/OneDrive - Johns Hopkins/EN.605.745/reynard/data/pz6.txt')
    ...
    def testPz6MakeInitialGuess(self):
        '''
        For puzzle 6 there are no one letter words
        '''
